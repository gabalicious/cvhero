  ...
  <div>
    ...
    <b-container class="bv-example-row">
      <div class="bolt-container">
        ...
        <b-modal
          modal-class="bg-heyui-modal"
          hide-backdrop
          content-class="bg-heyui"
          ...
          title="Options"
        >
          <app-buttonrow></app-buttonrow>
          <b-button class="btn-space" @click="toggleModal">Close</b-button>
        </b-modal>
      </div>
      <b-row>
        <b-col xl="12"></b-col>
      ...
      <b-row>
        ...
        <b-col xl="10">
          <span class="fix-height">
            <crud-basic-data></crud-basic-data>
          </span>
        </b-col>
        <b-col xl="1"></b-col>
      </b-row>
...
import CrudBasicData from "../components/data-components/CrudBasicData.vue";
...
export default Vue.extend({
  ...
  methods: {
    ...
    toggleModal() {
      this.$root.$emit("bv::toggle::modal", "toggle-menu", "#btnToggle");
    }
  },
  created: function () {
